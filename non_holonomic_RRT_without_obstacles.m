...
%Drawing a line depicting the orientation at the initial position
...
%Drawing a line depicting the orientation at the final position
...
rrt_tree.node(1).parent_velocity = 0; %This is the velocity at the parent node required to reach current node in the tree
rrt_tree.node(1).parent_steering_angle = 0; %This is the steering angle at the parent node required to reach current node in the tree. 
...
%initializing x,y-coordinate and orientation theta of new node that will be added in tree
...
while iter <= N
    ...
    if new_node_validity == 0
        ...
        %Uncomment this section to draw orientation at the new node in the
        %graph
        %{
